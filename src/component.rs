...
impl<A: Arena<Generation=G>, G: Generation, T> Get<Valid<'_, A>, T> for Component<A, T> {
...
impl<A: Arena<Generation=G>, G: Generation, T> Insert<Valid<'_, A>, T> for Component<A, T> {
